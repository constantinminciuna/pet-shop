...
<body>
	...
	<div class="main">  	
		<script>alert('Registrazione effettuata con successo. Effettuare il login.');</script>
		<input type="checkbox" id="chk" aria-hidden="true" checked>
			...
			<div class="login">
				...
				<div class="forgotpwd"><a href="forgotpwdform.jsp" position=>Password dimenticata?</a></div>
			</div>
	</div>
</body>
</html>